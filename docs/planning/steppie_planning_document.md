...
| 11 | v1.0 기능 마감 범위 확정 | 환경 설정, 진행 기록, 템플릿, 복구 코드, 사진 선택 마감 | 환경 설정, 진행 기록, 템플릿, 복구 코드, 사진 선택 마감 |
| 12 | 출시 체크리스트 확정 | App Store 준비 | Google Play 준비 |
...
- 환경 설정, 진행 기록, 복구 코드 화면 완성
- 기본 아이콘 60개 이상
- 사진 촬영/갤러리 업로드와 백업 복원 가능한 사진 참조
- 기본 템플릿 3종
- 오프라인 100% 동작
- 자정 루틴 리셋
